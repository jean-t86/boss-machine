  ...
  describe('PUT /api/minions/:minionId', function() {
    it('updates the correct minion and returns it', function() {
      ...
      return request(app)
          ...
          .then(() => {
            updatedMinionInfo = Object.assign(
                {}, initialMinion, {name: 'Test'},
            );
            return request(app)
                .put('/api/minions/1')
    ...
    it('updates the correct minion and persists to the database', function() {
      ...
      return request(app)
          ...
          .then(() => {
            updatedMinionInfo = Object.assign(
                {}, initialMinion, {name: 'Persistence Test'},
            );
            return request(app)
                .put('/api/minions/1')
                .send(updatedMinionInfo);
        ...
        function() {
          ...
          return request(app)
              ...
              .then((afterPutResponse) => {
                ...
                expect(initialMinionsArray).to.be.deep.
                    equal(postRequestMinionsArray);
              });
        });
  });
    ...
    it('deletes the correct minion by id', function() {
      ...
      return request(app)
          ...
          .then((afterDeleteMinionsArray) => {
            expect(afterDeleteMinionsArray).to.not.be.deep
                .equal(initialMinionsArray);
            const shouldBeDeletedMinion = afterDeleteMinionsArray
                .find((el) => el.id === '1');
  ...
  describe('PUT /api/ideas/:ideaId', function() {
    ...
    it('updates the correct idea and persists to the database', function() {
      ...
      return request(app)
          ...
          .then(() => {
            updatedIdeaInfo = Object.assign(
                {}, initialIdea, {name: 'Persistence Test'},
            );
            return request(app)
                .put('/api/ideas/1')
                .send(updatedIdeaInfo);
        ...
        function() {
          ...
          return request(app)
              ...
              .then((postRequestIdeasArray) => {
                expect(initialIdeasArray).to.be.deep
                    .equal(postRequestIdeasArray);
              });
        });
  });
    ...
    it('deletes the correct minion by id', function() {
      ...
      return request(app)
          ...
          .then((afterDeleteIdeasArray) => {
            expect(afterDeleteIdeasArray).to.not.be.deep
                .equal(initialIdeasArray);
            const shouldBeDeletedIdea = afterDeleteIdeasArray
                .find((el) => el.id === '1');
    ...
    it('should persist the created meeting to the database', function() {
      ...
      return request(app)
          ...
          .then((newMeetingsArray) => {
            expect(newMeetingsArray.length).to
                .equal(initialMeetingsArray.length + 1);
    ...
    it('updates the correct work item and persists to the database',
        function() {
          ...
          return request(app)
              ...
              .then(() => {
                updatedWorkInfo = Object.assign(
                    {}, initialWork, {title: 'Persistence Test'},
                );
                return request(app)
                    .put(`/api/minions/2/work/${initialWork.id}`)
                    .send(updatedWorkInfo);
              ...
              .then((postUpdateWorkArray) => {
                const updatedWorkObject = postUpdateWorkArray
                    .find((work) => work.id === initialWork.id);
                expect(updatedWorkObject).to.have
                    .property('title', 'Persistence Test');
              });
        });
        ...
        function() {
          ...
          return request(app)
              ...
              .then((postRequestWorkArray) => {
                expect(initialMinionsWorkArray).to.be.deep
                    .equal(postRequestWorkArray);
              });
        });
    ...
    it('deletes the correct work by id', function() {
      ...
      return request(app)
          ...
          .then((afterDeleteWorkArray) => {
            ...
            const shouldBeDeletedWork = afterDeleteWorkArray
                .find((el) => el.id === '2');
